...
public class DataProviderRep_HashMap {
	...
	@DataProvider(name="newManagerData")
	public static Object[][] getNewCompData10() {
    	String path= System.getProperty("user.dir")+"\\Test Excel Files\\" + "NewManagerTestData.xlsx";
    	excelReader=new ExcelReader(path);
		String sheetName="NewManagerData";
