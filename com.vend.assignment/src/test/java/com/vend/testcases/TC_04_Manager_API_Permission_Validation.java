...
public class TC_04_Manager_API_Permission_Validation extends BaseSetUp {
	...
	public void TC_04_Manager_API_Permission_Validation(Map <String,String> data)
	{
	signInPgObj = new Vend_Page_Account_Login(driver);
		...
		Assert.assertFalse("Apply Discount text box is not enabled",flag);
